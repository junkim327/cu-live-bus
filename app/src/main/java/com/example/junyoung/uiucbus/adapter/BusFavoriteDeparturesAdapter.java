...
import com.example.junyoung.uiucbus.adapter.BusDeparturesAdapter.BusDeparturesViewHolder;
...
public class BusFavoriteDeparturesAdapter
  ...
  public int getItemViewType(int position) {
    return mDepartureList.get(position).isBusDeparture() ? DEPARTURE : HEADER;
  }
