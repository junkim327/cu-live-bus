...
public interface UserSavedBusStopDao {
  ...
  @Query("SELECT Count(*) From user_saved_bus_stop_table WHERE uid = :userId AND saved_stop_id = " +
    ":busStopId")
  public Flowable<Integer> getNumBusStopsByUid(String userId, String busStopId);
}
